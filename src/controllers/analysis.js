...
exports.post = (req, res) => {
  ...
  form.parse(req, (err, fields, files) => {
    ...
    const imagesNames = [files.img1A.path.split('/')[7],
      files.img2A.path.split('/')[7],
      files.img1B.path.split('/')[7],
      files.img2B.path.split('/')[7],
      files.img1C.path.split('/')[7],
      files.img2C.path.split('/')[7],
      files.img1D.path.split('/')[7],
      files.img2D.path.split('/')[7],
      files.img1E.path.split('/')[7],
      files.img2E.path.split('/')[7]
    ];
    ...
    const solutionsForWordFile = ['sol1', 'sol2'];
    ...
    for (let j = 0; j < 2; j++) {
      inputsValues[solutionsForWordFile[j]] = solutionA1;
    }
